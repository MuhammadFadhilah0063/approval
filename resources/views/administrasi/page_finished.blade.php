              ...
              <div class="card">
                <div class="card-body">
                  <div class="text-center">
                    <span class="fw-bold" style="font-size: 21px; display: block; margin-bottom: 6px;">
                      Terima Kasih!
                    </span>
                    <span>Sudah mengisi Tanda Terima Peraturan Perusahaan (2024-2026), dokumen bisa bapak/ibu akses pada
                      link berikut:</span><br>

                    <span style="display: block; margin-bottom: 6px; margin-top: 15px;">
                      PT. PPA:
                      <br>
                      <a href="/assets/documents/pp_ppa.pdf" target="_blank">Link Dokumen PP</a>
                    </span>

                    <span style="display: block; margin-bottom: 6px; margin-top: 15px;">
                      PT. AMM:
                      <br>
                      <a href="/assets/documents/pp_amm.pdf" target="_blank">Link Dokumen PP</a>
                    </span>
                  </div>
                </div>
              </div>
